...
import 'package:propzy_home/src/presentation/ui/search/fitter/property/property.dart';
...
import 'bathroom/bathroom.dart';
import 'bedroom/bedroom.dart';

class TabRentFilterPage extends StatefulWidget {
  const TabRentFilterPage({Key? key}) : super(key: key);

  @override
  State<TabRentFilterPage> createState() => TabRentFilterPageState();
}


class TabRentFilterPageState extends State<TabRentFilterPage> {
        ...
        children: [
          Column(
            ...
            children: [
              ...
              PropertyPage(
                categoryType: CategoryType.RENT, listingTypeId: CategoryType.RENT.type,
              ),
              SizedBox(
                height: 16,
              ),
