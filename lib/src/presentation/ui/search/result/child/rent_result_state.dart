...
import 'package:propzy_home/src/presentation/ui/search/result/empty/rent_empty_search.dart';
...
class SearchRentState extends BaseSearchResultState<CategoryHomeListing> {
  @override
  String getSortTile(int? totalItem) => 'Có $totalItem BĐS cho thuê';

  @override
  BaseResultBloc<CategoryHomeListing> homeResultBloc = ResultHomeBloc();

  @override
  Widget buildEmptyView() => RentEmptySearchView(parentBloc: homeResultBloc);
