...
import 'package:propzy_home/src/presentation/ui/search/result/child/rent_result_state.dart';

class RentResultWidget extends BaseResultWidget {
  RentResultWidget({
  ...
  @override
  State<StatefulWidget> createState() => SearchRentState();
}
